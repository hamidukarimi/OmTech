...
let About = () => {
  ...
  return (
    <div>
      ...
      <div className="hero-content absolute top-72 left-4 md:left-12 right-4 md:right-12 xl:left-52 text-white z-30">
        <p className="text-[48px] font-bold leading-tight">About Us</p>
        <p className="text-3xl font-bold mt-2 xl:w-[700px]">
          Lorem Ispum doller amit sit om for things over the other things we see
          them.
        </p>
      </div>

      <div className="w-full  bg-darkGray rounded-[20px_20px_0_0] -mt-16 z-20 relative font-bold px-5 md:px-14 xl:px-52 pt-6 ">
        ...
        <div className="text-center mt-14">
          ...
          <div className="px-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-5 ">
            {ourTeam.map((card) => (
              <div className=" w-full h-[360px] rounded-3xl  relative">
      ...
      <div className="px-5 md:px-14 xl:px-52 pb-28    grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-14 md:gap-5">
        <TestimonialCard
